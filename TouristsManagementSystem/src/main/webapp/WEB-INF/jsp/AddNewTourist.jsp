...
<form action="/save" method="post" modelAttribute="Tourist">
		...
		<br> Enter 2nd Phone Number: <input type="text" name="phoneNumber2" placeholder="2nd Phone Number" value="0"><br>
		<br> Enter 3rd Phone Number: <input type="text" name="phoneNumber3" placeholder="3rd Phone Number" value="0"><br>
